...
import coffeeImg from './assets/tea.png'
...
function App() {
  ...
  const checkBalance = async () => {
    ...
    if (ethereum) {
      const provider = new ethers.providers.Web3Provider(ethereum);
      const balance = await provider.getBalance('0x6414493317396E0b163b1704a50E4170a7528e21');
    ...
    <>
      {
        CurrentAccount ? (
          <div className="App">
            ...
            <form onSubmit={e => { e.preventDefault() }}>
              ...
              <button
                ...
                onClick={buyCoffee}
              >
                1 Small Tea for 0.001ETH
              </button>
              <button
                type="button"
                onClick={buyLargeCoffee}
              >
                1 Large Tea for 0.003ETH
              </button>
              {checkOwner() && (<>
          ...
          <div className="App">
            <h1>Buy <span style={{ fontFamily: "Roboto" }}>ME</span> a Tea</h1>
            <img src={coffeeImg} alt='coffee' />
      ...
      {(memos.map((memo, idx) => {
        return (
          <div key={idx} style={{ border: "3px solid goldenrod", borderRadius: "5px", padding: "5px", margin: "5px", backgroundColor: 'white' }}>
            <p style={{ color: 'goldenrod', fontFamily: 'Roboto', fontSize: '25px' }}>{memo.coffeeType} Coffee</p>
      ...
      <br />
      <a href="https://github.com/cracksteady" target={'_blank'}>
        <i className="fa-brands fa-github"></i>
      </a>
      <a href="https://twitter.com/jovyfullon23" target={'_blank'}>
        <i className="fa-brands fa-twitter"></i>
      </a>
      <a href="https://t.me/Jaredtot29" target={'_blank'}>
